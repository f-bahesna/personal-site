<template>
  <div class="container flex flex-col px-6 pt-12 sm:py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
    ...
    <div class="flex items-center justify-center w-full h-96 md:w-1/2">
      <img class="object-cover w-1/2 h-1/2 sm:h-full max-w-2xl -mt-12 sm:mt-0 rounded-md" src="https://res.cloudinary.com/jadikaya-9/image/upload/v1654046018/fbahesna/frada_plpkkn.jpg" alt="lianum frada bahesna">
    </div>
  </div>
  <follow-me />
</template>
